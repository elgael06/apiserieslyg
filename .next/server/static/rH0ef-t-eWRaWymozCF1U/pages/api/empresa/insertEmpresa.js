...
module.exports = __webpack_require__("Pmzy");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method == 'POST') {
    ...
    console.log('listo');
    const value = await (await Object(_database__WEBPACK_IMPORTED_MODULE_0__[/* insert */ "b"])()).newEmpresa(nombre, telefono, direccion);
