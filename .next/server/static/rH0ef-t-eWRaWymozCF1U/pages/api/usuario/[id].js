...
module.exports = __webpack_require__("wMFU");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  const usuario = await (await Object(_database__WEBPACK_IMPORTED_MODULE_0__[/* select */ "c"])()).idUsuario(parseInt(id.toString()));
  res.json(usuario);
});
