...
module.exports = __webpack_require__("uat4");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method == 'POST') {
    ...
    const value = await (await Object(_database__WEBPACK_IMPORTED_MODULE_0__[/* insert */ "b"])()).newUsuario(nombre, apPat, apMat, puesto);
