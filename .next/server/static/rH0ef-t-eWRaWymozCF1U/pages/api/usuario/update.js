...
module.exports = __webpack_require__("xK7/");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method == 'POST') {
    ...
    const value = await (await Object(_database__WEBPACK_IMPORTED_MODULE_0__[/* update */ "d"])()).updateUsuario(id, nombre, apPaterno, apMaterno, puesto);
    res.json(value);
  }
});
