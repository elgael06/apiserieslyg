...
/* harmony import */ var _database_delete__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("/ncD");


/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  const id = req.query['id'];
  const mensaje = await (await Object(_database_delete__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])()).idUsuario(parseInt(id.toString()));
  res.json(mensaje);
});
...
module.exports = __webpack_require__("2VoH");
