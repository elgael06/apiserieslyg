...
// CONCATENATED MODULE: ./store/reducers/usuario.js
...
/* harmony default export */ var usuario = ((state = initialState, actions) => {
  switch (actions.type) {
    case types["a" /* ADD_USER */]:
...
// CONCATENATED MODULE: ./store/reducers/listaUsuarios.js

/* harmony default export */ var listaUsuarios = ((state = [], actions) => {
  switch (actions.type) {
    case types["b" /* GET_USUARIOS */]:
...
const midleware = [external_redux_thunk_default.a];
const store = Object(external_redux_["createStore"])(reducers, store_initialState, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(...midleware)));
/* harmony default export */ var store_store = (store);
// EXTERNAL MODULE: ./pages/components/Layout.jsx
var Layout = __webpack_require__("EpIr");
...
class _app_MyApp extends app_default.a {
  render() {
    ...
    return __jsx(external_react_redux_["Provider"], {
      store: store_store
    }, __jsx(Layout["default"], null, __jsx(Component, pageProps, "  ")));
  }
